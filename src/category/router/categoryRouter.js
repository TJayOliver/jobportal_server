...
categoryRouter.get("/category/count", async (req, res) =>
  categoryController.countCategory(req, res)
);
categoryRouter.get("/category/edit/:id", async (req, res) =>
...
categoryRouter.put("/category/update/:id", async (req, res) =>
