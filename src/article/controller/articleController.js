class ArticleController {
  ...
  async createArticle(req, res) {
    try {
      const { title, author, post, featured, mainfeatured, category } =
        req.body;
      ...
      return res
        .status(201)
        .json({ message: "Successfully Created", data: article });
    } catch (error) {
  ...
  async readArticleByCategory(req, res) {
    try {
      ...
      return res
        .status(201)
        .json({ message: "Retrieved Successfully", data: article });
    } catch (error) {
  ...
  async readMainFeaturedArticle(req, res) {
    try {
      ...
      return res
        .status(201)
        .json({ message: "Successfully Retrieved", data: article });
    } catch (error) {
  ...
  async editArticle(req, res) {
    ...
    try {
      ...
      return res
        .status(201)
        .json({ message: "Successfully Deleted", data: article });
    } catch (error) {
  ...
  async updateArticle(req, res) {
    try {
      ...
      return res
        .status(201)
        .json({ message: "Successfully Updated", data: article });
    } catch (error) {
